...
@pytest.mark.parametrize(
    ...
    ["http://127.0.0.1:8100", "http://localhost:8100", "http://[::1]:8100"],
)
def test_production_accepts_loopback_embedding_service_for_single_host_deployment(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Loopback is trusted; any other unencrypted bridge/LAN hostname is not.
        ("embedding_service_url", "http://embedding-service:8100"),
        ("embedding_service_url", "http://127.0.0.1.attacker.test:8100"),
    ],
)
