...
class Settings(BaseSettings):
    ...
    model_load_max_attempts: int = Field(default=3, ge=1, le=10)
    model_load_retry_base_seconds: float = Field(default=2.0, gt=0, le=30)
    ...
    def safe_summary(self) -> dict[str, Any]:
        return {
            ...
            "model_load_max_attempts": self.model_load_max_attempts,
            "model_load_retry_base_seconds": self.model_load_retry_base_seconds,
