...
class FakeModel:
    ...
    def load(self) -> None:
        ...
        if self.load_failure or self.load_calls <= self.load_failure_count:
...
def make_settings(**overrides: object) -> Settings:
    values: dict[str, object] = {
        ...
        # Pinned so unrelated tests see a single fast load attempt by default;
        # dedicated retry tests override both explicitly.
        "model_load_max_attempts": 1,
        "model_load_retry_base_seconds": 0.01,
    }
